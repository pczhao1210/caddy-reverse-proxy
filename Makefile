...
IMAGE ?= caddy-reverse-proxy:latest
BACKEND_DIR := backend
ENV_FILE ?= .env

.PHONY: help test test-e2e docker-build docker-push docker-run compose-up compose-up-proxy compose-down
